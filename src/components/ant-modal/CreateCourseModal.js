...
import { Button, Form, Icon, Input, Modal, Row, Col, DatePicker } from "antd";
      ...
      <div>
        ...
        >
          <Form onSubmit={this.handleSubmit}>
            ...
            <Form.Item style={{ marginBottom: -1 }}>Prerequisites</Form.Item>
            <Form.Item
              style={{ marginBottom: -1 }}
            ...
            <Form.Item style={{ marginTop: "10%" }}>
              <Row>
                <Col span={12} style={{ textAlign: "end", paddingRight: "5%" }}>
                  <Button style={{ width: "50%" }} onClick={this.handleCancel}>
                    Back
                  </Button>
                </Col>
                <Col span={12}>
...
const WrappedCreateCourseModal = Form.create({ name: "horizontal_login" })(
  CreateCourseModal
);
